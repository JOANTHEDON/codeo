                ...
                messages: [
                    {
                        role: "system",
                        content:
                            "You are a code generator copilot. Generate code based on the given prompt without any explanation. Return only the code, formatted in Markdown using the appropriate language syntax (e.g., ```js for JavaScript, ```py for Python). Do not include any additional text or explanations.",
                    },
                    {
                        role: "user",
                        content: input,
